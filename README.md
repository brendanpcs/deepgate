...
```bash
./gradlew test          # pure JUnit, no Minecraft needed  (112 tests)
./gradlew runGametest   # world-dependent behaviour        (31 tests)
...
| M2 | `/spawn` and beacon homes | **Done** - builds, 112 unit + 31 game tests green |
